import 'dart:convert';
import 'package:srk_news/model.dart';
...
class _CategoryState extends State<Category> {
  ...
  getNewsByQuery(String query) async {
    ...
    if(query == "Top News" || query == "India"){
      ...
      url ="https://newsapi.org/v2/everything?q=$query&from=2021-06-28&sortBy=publishedAt&apiKey=9bb7bf6152d147ad8ba14cd0e7452f2f";
    }
